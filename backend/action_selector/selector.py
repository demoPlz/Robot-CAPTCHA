...
Defines the contract that all action selectors must implement for selecting
actions from a set of crowdsourced submissions.
"""
...
class ActionSelector(ABC):
    ...
    All selectors must implement select() which returns both the selected action
    and its propensity (probability of selection) for importance weighting in training.
    """
