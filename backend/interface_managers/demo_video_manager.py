...
class DemoVideoManager:
    ...
    def _compute_next_video_index(self) -> int:
        ...
        Accepts files named like '1.webm', '2.mp4', etc. If directory is empty (typical after clear), returns 1.
    ...
    def find_latest_show_video(self) -> tuple[Path | None, str | None]:
        """Return (path, id_str) of the latest .webm in _show_videos_dir. Files must be named like '<number>.webm'
        (e.g., 1.webm, 2.webm).
