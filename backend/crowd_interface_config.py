...
class CrowdInterfaceConfig:
    ...
    def __init__(self):
        ...
        if self.task_name == "drawer":
            ...
            self.objects: dict[str, str] = {"Cube_Yellow": "Yellow object", "Cube_Green": "Green object", "Cube_Red": "Red object"}
            self.object_mesh_paths: dict[str, str] = {
    ...
    def to_crowd_interface_kwargs(self) -> dict:
        ...
        # Optional: frontend URL for serving uncompressed videos
        if self.frontend_url:
            kwargs["frontend_url"] = self.frontend_url
