...
def create_flask_app(crowd_interface: CrowdInterface) -> Flask:
            ...
            response = jsonify(
                {
                    ...
                    "original_joint_positions": pending.get("original_joint_positions", []),  # Starting position
    ...
    def start_animation():
        ...
        try:
            ...
            episode_id = data.get("episode_id")  # NEW: extract episode_id
            state_id = data.get("state_id")  # NEW: extract state_id
